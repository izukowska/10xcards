      ...
      <div className="bg-card border rounded-lg shadow-lg p-4 mx-auto max-w-4xl">
        <div className="flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
          <div className="flex flex-wrap items-center gap-2">
            <span className="text-sm font-medium">Fiszki: {totalCount}</span>
          ...
          <div className="flex flex-wrap items-center gap-2">
            <Button onClick={onRejectAll} disabled={isSaving} variant="outline" size="sm">
              Odrzuć wszystkie
            </Button>
            <Button onClick={onAcceptAll} disabled={isSaving} size="sm">
              Zaakceptuj wszystkie
            </Button>
            {acceptedCount > 0 && (
              <Button onClick={onSaveAccepted} disabled={isSaving} size="default">
